...
```{r}
lm_lucro <- lm(Lucro ~ PeD + Marketing + Administracao, data = dataset)
tidy(lm_lucro)
glance(lm_lucro)
...
**Lucro = *(0.8)*.PeD + *(0.03)*.MKT + *(-0.02)*.ADM**, que explicaria **95%** da variância da variável de resposta (R² = 0.946374). 
